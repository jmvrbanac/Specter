# -*- coding: utf-8 -*-
#
# Specter documentation build configuration file, created by
# sphinx-quickstart on Sun Oct  6 00:09:22 2013.
#
...
project = u'Specter'
copyright = u'2013-2016, John Vrbanac'
...
texinfo_documents = [
  ('index', 'Specter', u'Specter Documentation',
   u'John Vrbanac', 'Specter', 'One line description of project.',
   'Miscellaneous'),
]
